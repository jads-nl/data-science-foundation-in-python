...
If you'd like to develop and/or build the Data Science Foundation Curriculum book, you should:
...
We welcome and recognize all contributions. You can see a list of current contributors in the [contributors tab](https://github.com/dkapitan/data_science_foundation_curriculum/graphs/contributors).
