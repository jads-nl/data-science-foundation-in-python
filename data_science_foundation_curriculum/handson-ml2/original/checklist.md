# Checklist for doing machine learning projects

Before diving head-first into the code, here is a nice checklist to guide you in gaining hands-on experience. Following the CRISP-DM framework, consider these eight main steps:  
...
### 1. Frame the problem and look at the big picture (business understanding)
...
## 2. Get the data (data understanding I)
...
## 3. Explore the data  (data understanding II)
...
## 4. Prepare the data (data preparation)
Notes:    
...
## 5. Short-list promising models (modeling)
Notes: 
...
## 6. Fine-Tune the System (modeling) 
Notes:  
...
## 7. Present your solution (evaluation) 
